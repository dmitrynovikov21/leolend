...
import {
    ...
    BarChart3, Sliders, Plug, FileCheck, Brain, Send, GraduationCap, ChevronDown
} from "lucide-react"
...
function HeroSectionNew() {
    ...
    return (
        <main className="bg-white text-[#2d323e] font-sans">
            <RoistatHeader />
                ...
                <div className="max-w-7xl mx-auto px-6 w-full pt-20 pb-20">
                    ...
                    >
                        ...
                        <div className="max-w-xl lg:col-span-5">
                            ...
                            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight leading-tight text-[#2d323e] mb-6">
                            ...
                            <p className="text-base md:text-lg text-[#6b7280] mt-6 leading-relaxed mb-8">
                                Выберите роль ИИ-агента, загрузите документы и он начнёт отвечать строго в рамках загруженных данных. Любой менеджер может настроить агента без ИТ-специалистов <strong className="text-[#2d323e]">за 7 минут</strong>.
                            </p>
                            ...
                            <form onSubmit={handleSubmit} className="flex w-full max-w-md gap-x-3">
                                <input
                                    ...
                                    required
                                    className="h-12 flex-auto rounded-md border border-[#dce1e6] bg-white px-4 text-[#2d323e] shadow-sm placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#0077FF] sm:text-sm sm:leading-6"
                                />
                                <button
                                    type="submit"
                                    className="h-12 rounded-md bg-[#0077FF] px-6 text-sm font-semibold text-white shadow-sm hover:bg-[#0060cc] transition-colors flex items-center gap-2 whitespace-nowrap"
                                >
                                    Создать агента
                                </button>
                            </form>
...
function RoistatDropdown({
    ...
    return (
        <div className="relative">
            <button
                onClick={onToggle}
                className="flex items-center gap-1 text-[15px] font-medium text-[#2d323e] hover:text-[#0077FF] transition-colors py-2"
            >
                {label}
                    ...
                    >
                        {items.map((item) => (
                            <Link
                                key={item.label}
                                href={item.href}
                                className="block px-4 py-2.5 text-sm text-[#2d323e]/80 hover:text-[#0077FF] hover:bg-zinc-50 transition-colors"
                                onClick={onToggle}
                            >
                                {item.label}
                            </Link>
            ...
            <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-12">
                    ...
                    <nav className="hidden lg:flex items-center gap-6">
                        ...
                        />
                        <Link href="#partners" className="text-[15px] font-medium text-[#2d323e] hover:text-[#0077FF] transition-colors">
                            Партнёрам
                        </Link>
                        <Link href="/docs" className="text-[15px] font-medium text-[#2d323e] hover:text-[#0077FF] transition-colors">
                            Документация
                        </Link>
                        <Link href="#pricing" className="text-[15px] font-medium text-[#2d323e] hover:text-[#0077FF] transition-colors">
                            Цены
                        </Link>
                    </nav>
                </div>
                ...
                <div className="flex items-center gap-6">
                    ...
                    <button className="h-9 px-5 rounded-[4px] bg-[#0077FF] text-white text-[14px] font-bold hover:bg-[#0060cc] transition-colors shadow-sm">
                        Регистрация
                    </button>
                </div>
            </div>
                    ...
                    {steps.map((step, i) => (
                        ...
                        >
                            ...
                            <div className="order-1 lg:order-2">
                                <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden aspect-[4/3] relative group transition-all duration-500">
                    ...
                    <div className="bg-[#0077FF] p-12 lg:p-16 flex flex-col justify-center">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
                            <input
                                ...
                                required
                                className="flex-1 h-14 px-5 rounded-md bg-white text-gray-900 placeholder:text-gray-400 text-base focus:outline-none focus:ring-2 focus:ring-white/50"
                            />
                            <button
                                type="submit"
                                className="h-14 px-8 bg-zinc-900 text-white rounded-md font-semibold text-base hover:bg-zinc-800 transition-colors flex items-center justify-center gap-2 whitespace-nowrap"
                            >
                                Попробовать
