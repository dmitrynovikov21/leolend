...
import {
    ...
    BarChart3, Sliders, Plug, FileCheck, Brain, Send, GraduationCap
} from "lucide-react"
            ...
            <div className="max-w-7xl mx-auto px-6 w-full">
                ...
                >
                    ...
                    <div className="max-w-xl lg:col-span-5">
                        ...
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight leading-tight text-zinc-900">
                            ИИ-агент обучен на <span className="underline decoration-blue-500 decoration-2 underline-offset-4">ваших</span> документах и знает <span className="underline decoration-blue-500 decoration-2 underline-offset-4">правильные</span> ответы
                        </h1>

                        <p className="text-base md:text-lg text-zinc-500 mt-6 leading-relaxed">
                            Выберите роль ИИ-агента, загрузите документы и он начнёт отвечать строго в рамках загруженных данных. Любой менеджер может настроить агента без ИТ-специалистов <strong className="text-zinc-700">за 7 минут</strong>.
                        </p>

                        {/* Form */}
                        <form onSubmit={handleSubmit} className="mt-8 flex w-full max-w-md gap-x-3">
                            <input
                                type="email"
                                value={email}
                                ...
                                required
                                className="h-12 flex-auto rounded-xl border-0 bg-white px-4 shadow-sm ring-1 ring-inset ring-zinc-200 placeholder:text-zinc-400 focus:ring-2 focus:ring-inset focus:ring-zinc-900 text-sm backdrop-blur-sm"
                            />
                            <button
                                type="submit"
                                className="h-12 rounded-xl bg-zinc-900 px-6 text-sm font-semibold text-white shadow-sm hover:bg-zinc-800 transition-colors flex items-center gap-2"
                            >
                                Создать агента
...
function HeroInterfacePreview() {
    return (
        <div className="w-full bg-white rounded-xl shadow-2xl border border-zinc-200 overflow-hidden text-left flex flex-col">
            {/* Window Header */}
                ...
                <div className="w-full md:w-1/3 bg-white border-b md:border-b-0 md:border-r border-zinc-100 p-6 flex flex-col gap-6">
                    ...
                    <div>
                        ...
                        <div className="p-3 bg-white border border-blue-100 rounded-xl shadow-sm flex items-center gap-3">
                            ...
                            <span className="text-sm font-medium text-zinc-900 leading-tight">Онбординг-агент для новых сотрудников</span>
                        </div>
                    </div>
                        ...
                        <div className="space-y-2">
                            {[
                                ...
                                <div key={i} className="group p-3 bg-white border border-zinc-100 hover:border-zinc-300 rounded-xl flex items-center gap-3 transition-colors cursor-default">
                                    ...
                                    <span className="text-sm text-zinc-600 truncate">{doc.name}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 flex-1 overflow-y-auto pr-2 min-h-0 custom-scrollbar">
                        ...
                        <div className="flex justify-start">
                            <div className="bg-white border border-zinc-200 text-zinc-800 px-5 py-4 rounded-2xl rounded-tl-sm max-w-[90%] text-sm shadow-sm space-y-3">
                                <p className="font-medium text-zinc-900">Согласно HR-политикам, для оформления отпуска необходимо:</p>
        ...
        <section className="py-20 bg-zinc-50">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {advantages.map((adv, i) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="p-6 bg-white rounded-2xl border border-zinc-200 hover:border-zinc-300 hover:shadow-lg transition-all"
                        >
                            <div className="w-12 h-12 bg-zinc-100 rounded-xl flex items-center justify-center mb-4">
                                <adv.icon className="w-6 h-6 text-zinc-900" />
                            </div>
                            <h3 className="text-lg font-semibold text-zinc-900 mb-2">{adv.title}</h3>
                ...
                <div className="mt-12 text-center">
                    <button className="inline-flex items-center gap-2 px-6 py-3 bg-zinc-900 text-white rounded-xl font-semibold hover:bg-zinc-800 transition-colors">
...
function StepsSection() {
    const steps = [
        {
            id: "01",
            title: "Определите роль",
            desc: "Выберите из готовых шаблонов: поддержка, HR, продажи или создайте своего уникального агента. Агент сразу поймет свой Tone of Voice и специфику работы.",
            visual: <StepRoleVisual />
        },
        {
            id: "02",
            title: "Загрузите знания",
            desc: "PDF, Word, Excel, ссылки на сайт или Notion. Просто перетащите файлы в базу знаний. Агент изучит их за минуту и разложит по полочкам.",
            visual: <StepUploadVisual />
        },
        {
            id: "03",
            title: "Проверьте качество",
            desc: "Встроенный инструмент автотестирования найдет противоречия в инструкциях. Проверьте ответы в песочнице и скорректируйте поведение.",
            visual: <StepQualityVisual />
        },
        {
            id: "04",
            title: "Подключите интеграции",
            desc: "Свяжите агента с Telegram, WhatsApp, вашим сайтом или CRM-системой. Всё подключается в пару кликов без программирования.",
            visual: <StepIntegrationsVisual />
        }
    ]
                    ...
                    {steps.map((step, i) => (
                        ...
                        >
                            ...
                            <div className="order-2 lg:order-1">
                                <span className="inline-block text-6xl md:text-8xl font-black text-zinc-100 font-urban leading-none mb-6 select-none">
                                    {step.id}
                                </span>
                                <h3 className="text-2xl md:text-4xl font-bold text-zinc-900 mb-6 leading-tight">
                                    {step.title}
                                </h3>
                            ...
                            <div className="order-1 lg:order-2">
                                <div className="bg-zinc-50 rounded-[2.5rem] border border-zinc-100 shadow-xl shadow-zinc-200/40 overflow-hidden aspect-[4/3] relative group hover:shadow-2xl hover:shadow-zinc-200/50 transition-all duration-500">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-6 sm:p-12">
            <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl border border-zinc-200 overflow-hidden">
                ...
                <div className="p-2 space-y-1">
                    ...
                    <div className="px-4 py-3 rounded-xl flex items-center gap-3 text-zinc-500 hover:bg-zinc-50 transition-colors cursor-pointer">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative w-64 h-64 flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
                    ...
                    <div className="font-bold text-zinc-900 text-base">knowledge.pdf</div>
                    <motion.div
                        initial={{ opacity: 0 }}
        ...
        <div className="absolute inset-0 flex items-center justify-center p-8 text-left">
            <div className="w-full max-w-md space-y-4">
                ...
                >
                    ...
                    <div className="flex items-center gap-2 text-zinc-600 text-sm font-medium bg-zinc-50 px-3 py-1.5 rounded-lg border border-zinc-100">
                        Дружелюбный 😊
                    </div>
                </motion.div>
        ...
        <section className="py-16 bg-white">
            <div className="max-w-7xl mx-auto px-6">
                <motion.div
                    ...
                    transition={{ duration: 0.5 }}
                    viewport={{ once: true }}
                    className="grid grid-cols-1 lg:grid-cols-2 rounded-3xl overflow-hidden shadow-2xl min-h-[400px]"
                >
                    {/* Left: Blue CTA */}
                    <div className="bg-blue-500 p-12 lg:p-16 flex flex-col justify-center">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
                            <input
                                ...
                                required
                                className="flex-1 h-14 px-5 rounded-xl bg-white text-zinc-900 placeholder:text-zinc-400 text-base focus:outline-none focus:ring-2 focus:ring-white/50"
                            />
                            <button
                                type="submit"
                                className="h-14 px-8 bg-zinc-900 text-white rounded-xl font-semibold text-base hover:bg-zinc-800 transition-colors flex items-center justify-center gap-2 whitespace-nowrap"
                            >
                                Попробовать
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {audiences.map((aud, i) => (
                        <motion.div
                            ...
                            transition={{ duration: 0.4, delay: i * 0.1 }}
                            viewport={{ once: true }}
                            className="group relative p-8 bg-white rounded-3xl border border-zinc-200 hover:border-blue-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden"
                        >
                            <div className="relative z-10">
                                <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center mb-6">
                                    <aud.icon className="w-6 h-6 text-blue-600" />
                                </div>
                                <h3 className="text-lg font-bold text-zinc-900 mb-3">{aud.title}</h3>
                                <p className="text-sm text-zinc-500 leading-relaxed">{aud.desc}</p>
                            </div>
                            {/* Background Icon */}
                            {aud.bgIcon}
                        </motion.div>
            ...
            <div className="overflow-x-auto pb-8 -mx-6 px-6 md:mx-0 md:px-0">
                <div className="flex gap-6 min-w-full w-max md:w-auto">
                    {testimonials.map((item, i) => (
                        <div
                            key={i}
                            className="w-[320px] shrink-0 p-8 rounded-3xl bg-zinc-50 border border-zinc-200 hover:border-zinc-300 transition-colors"
                        >
                            <div className="flex flex-col gap-4 h-full">
                                ...
                                <div className="flex items-center gap-3 mt-4 pt-4 border-t border-zinc-200/50">
                                    <div className="size-10 rounded-full bg-white border border-zinc-200 flex items-center justify-center text-sm font-bold text-zinc-500 shadow-sm">
                                        {item.name.charAt(0)}
                                    </div>
                                    <div>
                    ...
                    {cases.map((c, i) => (
                        ...
                        >
                            ...
                            <div className="p-6 flex flex-col flex-1">
                                <p className="text-sm text-zinc-600 leading-relaxed flex-1">{c.desc}</p>
                                ...
                                <button className="w-full py-3 border border-zinc-200 rounded-xl text-sm font-semibold text-zinc-700 hover:bg-zinc-50 transition-colors flex items-center justify-center gap-2">
                                    Подробнее
                                    <ArrowRight className="w-4 h-4" />
                                </button>
                            </div>
                    ...
                    >
                        <div className="space-y-4">
                            <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-zinc-100">
                                <span className="text-zinc-600">Обработано диалогов</span>
                                <span className="text-2xl font-bold text-zinc-900">1,247</span>
                            </div>
                            <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-zinc-100">
                                <span className="text-zinc-600">Средняя оценка</span>
                                <span className="text-2xl font-bold text-green-600">4.8 ⭐</span>
                            </div>
                            <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-zinc-100">
                                <span className="text-zinc-600">Автоматически решено</span>
                                <span className="text-2xl font-bold text-zinc-900">87%</span>
                            </div>
                        </div>
                    </motion.div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {plans.map((plan, i) => (
                        <motion.div
                            ...
                            transition={{ duration: 0.4, delay: i * 0.1 }}
                            viewport={{ once: true }}
                            className={`relative p-6 rounded-3xl border ${plan.highlighted
                                ? "bg-white text-zinc-900 border-white shadow-xl scale-105"
                                : "bg-blue-500/30 backdrop-blur-sm text-white border-blue-400/30"
                                }`}
                        >
                            {plan.highlighted && (
                                <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-amber-400 text-zinc-900 text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                                    Популярный
                                </div>
                            )}
                            <h3 className={`text-lg font-bold ${plan.highlighted ? "text-zinc-900" : "text-white"}`}>
                                {plan.name}
                            </h3>
                            <div className="mt-4 mb-2">
                                <span className={`text-4xl font-extrabold ${plan.highlighted ? "text-zinc-900" : "text-white"}`}>
                                    {plan.price} ₽
                                </span>
                                <span className={`text-sm ${plan.highlighted ? "text-zinc-500" : "text-blue-100"}`}>
                                    {plan.period}
                                </span>
                            </div>
                            <div className={`text-sm mb-6 ${plan.highlighted ? "text-zinc-500" : "text-blue-100"}`}>
                            ...
                            <ul className="space-y-3 mb-6">
                                {plan.features.map((f) => (
                                    <li key={f} className="flex items-center gap-2 text-sm">
                                        ...
                                        <span className={plan.highlighted ? "text-zinc-600" : "text-blue-50"}>{f}</span>
                                    </li>
                                ))}
                            </ul>
                            <button className={`w-full py-3 rounded-xl font-semibold text-sm transition-colors ${plan.highlighted
...
function FooterNew() {
    return (
        <footer className="py-12 md:py-16 bg-white border-t border-zinc-200">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
                    ...
                    <div className="col-span-2 lg:col-span-2">
                        ...
                        <ul className="space-y-1 text-sm text-zinc-600">
                            <li><a href="mailto:hello@leoagent.ru" className="hover:text-zinc-900">hello@leoagent.ru</a></li>
                            <li><a href="tel:+74951285418" className="hover:text-zinc-900">+7 (495) 128-54-18</a></li>
                            <li className="text-zinc-500 text-xs pt-1">Москва, ул. Орджоникидзе, 11с1А</li>
                        </ul>
                        <a href="https://t.me/printrobot" className="inline-flex items-center gap-2 text-sm text-zinc-600 hover:text-zinc-900 mt-3">
                            <Send className="w-4 h-4" />
                            @printrobot
                        </a>
                    </div>
                    ...
                    {/* Column 2: Product */}
                    <div>
                        <h4 className="font-semibold text-zinc-900 mb-3 text-sm">Продукт</h4>
                        <ul className="space-y-1.5 text-sm text-zinc-600">
                            <li><Link href="#" className="hover:text-zinc-900">Возможности</Link></li>
                            <li><Link href="#" className="hover:text-zinc-900">Интеграции</Link></li>
                            <li><Link href="#pricing" className="hover:text-zinc-900">Цены</Link></li>
                            <li><Link href="#" className="hover:text-zinc-900">Безопасность</Link></li>
                        </ul>
                    </div>

                    {/* Column 3: Company */}
                    <div>
                        <h4 className="font-semibold text-zinc-900 mb-3 text-sm">Компания</h4>
                        <ul className="space-y-1.5 text-sm text-zinc-600">
                            <li><Link href="#" className="hover:text-zinc-900">О нас</Link></li>
                            <li><Link href="/blog" className="hover:text-zinc-900">Блог</Link></li>
                            <li><Link href="#" className="hover:text-zinc-900">Карьера</Link></li>
                            <li><Link href="#" className="hover:text-zinc-900">Контакты</Link></li>
                        </ul>
                    </div>

                    {/* Column 4: Resources */}
                    <div className="col-span-2 md:col-span-1">
                        <h4 className="font-semibold text-zinc-900 mb-3 text-sm">Ресурсы</h4>
                        <ul className="space-y-1.5 text-sm text-zinc-600">
                            <li><Link href="/docs" className="hover:text-zinc-900">Документация</Link></li>
                            <li><Link href="#" className="hover:text-zinc-900">Поддержка</Link></li>
                            <li><Link href="#" className="hover:text-zinc-900">API</Link></li>
                            <li><Link href="#" className="hover:text-zinc-900">Статус</Link></li>
                        </ul>
                    </div>
                </div>

                <div className="mt-8 pt-6 border-t border-zinc-200 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-zinc-500">
                    <p>© 2026 LeoAgent. Все права защищены.</p>
                    <div className="flex gap-4">
                        <Link href="#" className="hover:text-zinc-900">Политика конфиденциальности</Link>
                        <Link href="#" className="hover:text-zinc-900">Условия использования</Link>
                    </div>
                </div>
            </div>
        </footer>
